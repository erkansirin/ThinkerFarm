//
//  CarPlateDetector.swift
//  ThinkerFarm
//
//  Created by Erkan SIRIN on 30.10.2019.
...
let modelInfo: FileInfo = (name: "retrained_graph", extension: "tflite")
let labelsInfo: FileInfo = (name: "labelmap", extension: "txt")
/// This class handles all data preprocessing and makes calls to run inference on a given frame
/// by invoking the `Interpreter`. It then formats the inferences obtained and returns the top N
/// results for a successful inference.
@objc public class CarPlateDetector: NSObject {
